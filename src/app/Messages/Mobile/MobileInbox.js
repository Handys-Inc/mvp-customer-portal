...
import hanna from "../../../assets/sample/hanna.png";
  ...
  return (
    <div className="mb-48 pt-5">
      ...
      <div className="flex justify-end">
        {" "}
        <div className="bg-faintGray h-10 w-10 flex items-center justify-center rounded-full text-gray">
          <FiSearch size={20} />
        </div>
      </div>
            ...
            >
              ...
              <div className="text-left">
                <h3 className="font-bold text-lg">
                  {single.name}, {single.pro}
                </h3>
                <p className="text-gray text-sm">{single.lastMessage}</p>
                <div className="text-gray mt-2 text-xs">
                  Booking Completed | {single.date}
                </div>
              </div>
            </div>
            <Border />
