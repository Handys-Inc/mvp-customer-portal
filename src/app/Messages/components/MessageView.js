        ...
        <div className="flex gap-3 justify-start px-10 my-5">
          ...
          <div className="text-left w-3/5">
            ...
            <p className="text-gray text-sm font-light mt-2">
              ...
              scheduled. <br />
              <br /> To ensure a smooth process, please make sure the area to be
              painted is clear of furniture and personal items. If there are any
              special instructions or areas you would like us to focus on,
              please let me know in advance.
              <br />
              <br /> If you need to make any changes to the booking or have any
              questions, please do not hesitate to contact me. I look forward to
              providing you with my professional painting services.
              <br />
